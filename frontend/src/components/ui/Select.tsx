...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            'bg-[var(--input-bg)] border border-[color:var(--input-border)]',
            'text-[var(--input-text)]',
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.Label
        ref={ref}
        className={cn('py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--text-3)]', className)}
        {...props}
    />
));
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            'text-[var(--text-2)]',
            'focus:bg-[var(--surface-highlight)] focus:text-[var(--text)]',
            'data-[state=checked]:bg-[var(--surface-highlight)]',
